 ...
 * @private
 */
Code.TABS_ = ['blocks','javascript']; //, 'javascript','python','dart', 'lua', 'xml'
...
Code.mirrorEvent = function (masterEvent) {
  ...
  var blocklyEventType = masterEvent.type;
  var blockName = "None";
  var element   = "None";
  var blockField= "None"
  var newValue  = "None";
  var oldValue  = "None";
  var currentStudentCode = Blockly.JavaScript.workspaceToCode(Code.workspace);
  var rawJSON = masterEvent.toJson(); 
  ...
  if(blocklyEventType == Blockly.Events.DELETE){
    ...
    */
    ...
    //console.log("DELETE Event:"  + "Created Block(s): " + "blockName:" + blockName + " || " + "blockField:" + "-" +  " || " + "oldValue:" + "-" + " || " + "newValue:" + "-");
  }
  ...
  if (blocklyEventType == Blockly.Events.MOVE) {
    ...
    */
    ...
    //console.log("MOVE Event:"  + "MOVE Block(s): " + blockName + " || " + "blockField:" + "-" +  " || " + "oldValue:" + JSON.stringify(masterEvent.oldCoordinate, null,2)  + " || " + "newValue:" + JSON.stringify(masterEvent.newCoordinate,null,2));
  }

  //console.log("Event_Type:"  + blocklyEventType + "MOVE Block(s): " + blockName + " || " + "blockField:" + "-" +  " || " + "oldValue:" + JSON.stringify(masterEvent.oldCoordinate, null,2)  + " || " + "newValue:" + JSON.stringify(masterEvent.newCoordinate,null,2));
  ...
  //console.log(masterEvent.toJson());
  //EventLogging.callPHP(blocklyEventType, blockName, element, blockField,newValue,oldValue,scripts,currentStudentCode,rawJSON);
}

EventLogging.callPHP = function(eventType, blockName_, element_, someScripts) {
    ...
    console.log("localTimeString: " + localTimeString + "; Event: " + anEventType + "; Block: " + aBlock + "; Param: " + aParam + "\nScript: " + someScripts);
};
...
Code.drawVisualization = function() {
  ...
  data.addColumn('number','Bat');
  data.addColumn('number', 'Mosquito');

  console.log("data table after addColumn: " + data);

  var x = new Array (20);
  for(var i=0; i<20; i++){
    x[i] = new Array(3);//adding 3 column 
  }

  //x[0] = Code.plot(formula,0); 

  for(var i=0; i<20; i++){
    console.log("Code.plot: " + Code.plot(formula,i)); 
    x[i] = Code.plot(formula,i); 
    console.log("x[i]: " + x[i]);
  }

  data.addRows(x); //adding the whole table
...
Code.plot = function(code,time) {
  ...
  //for (var time = 1; time <= 20; time = Math.round((time + 0.1) * 10) / 10) {
    ...
    console.log("Bat: " + Bat);
    console.log("Mosquito: " + Mosquito); 
    console.log("table: " + table); 
    var x = new Array(3); 
    x[0] = 1; x[1] =2; x[2] =3; 
    console.log("this is an array x: " + x);
  //}
