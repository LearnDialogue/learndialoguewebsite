 ...
 * @private
 */
Code.TABS_ = ['blocks', 'xml']; //, 'javascript', 'php', 'python', 'dart', 'lua', 'xml'
...
Code.init = function() {
  ...
  //Code.workspace.addChangeListener('mirrorEvent', mirrorEvent, true);
  //Code.mirrorEvent(Code.workspace.addChangeListener());
...
Code.mirrorEvent = function(masterEvent){
  //var masterEvent = Code.workspace.addEventListener();
