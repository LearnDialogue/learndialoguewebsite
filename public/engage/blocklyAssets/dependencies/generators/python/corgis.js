 ...
 */
 Blockly.JavaScript['learndialoguegetnames'] = function(block) {
   Blockly.Python.definitions_['import_LearnDialogue'] = 'import LearnDialogue';
  var dropdown_names = block.getFieldValue('Names');
  var code = 'LearnDialogue.members.get_all()';
  return [code, Blockly.Python.ORDER_ATOMIC];
};
