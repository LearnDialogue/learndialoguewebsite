...
/*
 * LearnDialogue Members Data
 */
 Blockly.Blocks['learndialoguegetnames'] = {
   init: function() {
    this.appendDummyInput()
        .appendField(new Blockly.FieldImage("https://www.cise.ufl.edu/research/learndialogue/img/LearnDialogue.png", 150, 20, "*"))
        .appendField("getLearnDialogueMembers")
        .appendField(new Blockly.FieldDropdown([["Kristy", "KRISTY"], ["Xiaoxi", "XIAOXI"], ["Lydia", "LYDIA"]]), "Names");
